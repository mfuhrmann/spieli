...
Reported as [issue #814](https://github.com/mfuhrmann/spieli/issues/814) for Slovak. The reporter's diagnosis was correct — `locales/sk.json` is fine at 89% complete, including all 158 device names. The defect is entirely in registration.
