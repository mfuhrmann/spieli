...
- Your browser directly contacts Nominatim (search), the configured basemap provider (CartoDB by default) (map tiles), Panoramax (photos), and Mangrove.reviews — see [External Services](reference/external-services.md) for the full list
