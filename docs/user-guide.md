...
|---|---|
| Green | Detailed — mapped play equipment **and** at least one detail (surface, opening hours, or access) |
| Orange | Basic — one of the two, not both |
| Red | No details yet — the playground exists in OSM but carries no equipment and no details |
...
The colours describe the OSM data, not the real-world quality of the playground. The lowest step means nobody has mapped it yet, which is an invitation to help rather than a warning.
...
| Accessible play | At least one piece of *play equipment* tagged wheelchair-accessible — see [Wheelchair accessibility](#wheelchair-accessibility) |
...
|---|---|
| **Accessible play** | Someone tagged at least one device as accessible |
| **No accessible play recorded** | Someone surveyed the equipment here and none of it is tagged accessible |
...
| State | Meaning |
|---|---|
| **detailliert** (green) | Mapped play equipment **and** at least one detail (surface, opening hours, or access) |
| **grundlegend** (orange) | One of the two, not both |
| **keine Details** (red) | Neither |
...
- Status pills — completeness, data age, and (when tagged) a shade pill (Shaded / No shade), baby / toddler suitability, and accessible play (see [Wheelchair accessibility](#wheelchair-accessibility))
